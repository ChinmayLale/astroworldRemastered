...
function Services() {
    ...
    return (
        <Element name='skills'>
            <div className='relative w-full h-fit  flex flex-col items-center p-4 pt-8 bg-[#f8f6f6] overflow-hidden'>
                ...
                <div className='relative w-full h-[80vh] max-[650px]:h-[100vh]  flex flex-row items-center justify-center gap-8 max-[650px]:flex-col max-[650px]:pt-8'>
                    ...
                    <div className='relative w-[20%] h-[50vh] flex flex-col bg-gray-100 justify-end p-[2%] items-start  rounded-xl border border-gray-500 max-[650px]:h-[35vh] max-[650px]:w-[60%] max-[650px]:pb-8'>
