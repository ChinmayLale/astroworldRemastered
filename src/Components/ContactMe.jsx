                            ...
                            <form action="https://fabform.io/f/insert-form-id" method="POST">
                                <div class="mb-4">
                                    ...
                                    <input type="text" id="name" name="name" placeholder="John Doe" required
                                        class="w-full px-3 py-2 border rounded-md focus:outline-none focus:border-black bg-gray-50 text-black"/>
                                </div>
                                <div class="mb-4">
                                ...
                                <div class="mb-6">
                                    ...
                                    <textarea id="message" name="message" rows="4" placeholder="How can we help you?" required
                                        class="w-full px-3 py-2 border rounded-md focus:outline-none focus:border-black bg-gray-50 text-black"></textarea>
                                </div>
                                <button type="submit"
                                    class="bg-gray-500 text-gray-950 px-4 py-2 rounded-md hover:bg-gray-950 hover:text-gray-50 focus:outline-none focus:shadow-outline-blue">
                                    Send Message
                                </button>
