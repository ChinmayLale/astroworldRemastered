...
function AboutMe() {
    return (
        <Element name="about">
            <div className='relative w-full h-fit  flex flex-col items-center p-4 bg-[rgb(255,250,250)]'>
                    ...
                    <div className='relative w-[50%] h-[70vh] flex flex-col justify-around p-2 max-[650px]:w-full font-poppins max-[650px]:h-fit'>
                        <div className='relative w-full h-fit flex flex-row justify-start gap-2 max-[650px]:h-fit p-2 max-[650px]:scale-110 max-[650px]:justify-around'>
                            <div className='relative w-[30%] h-[30vh] flex flex-col bg-gray-100 justify-center items-center  rounded-xl border border-gray-500 max-[650px]:h-[15vh] max-[650px]:w[25vw]'>
                                <i class="ri-award-line relative text-[3.5vmax] font-[300] font-poppins"></i>
                            ...
                            <div className='relative w-[30%] h-[100%] flex flex-col bg-gray-50 justify-center items-center  rounded-xl border border-gray-500 max-[650px]:h-[15vh]'>
                                <i class="ri-stack-line relative text-[3.5vmax] font-[300] font-poppins"></i>
                            ...
                            <div className='relative w-[30%] h-full flex flex-col bg-gray-50 justify-center items-center  rounded-xl border border-gray-500 max-[650px]:h-[15vh]'>
                                <i class="ri-braces-line relative text-[3.5vmax]  font-poppins"></i>
                        ...
                        <div className='relative w-full h-fit flex flex-col pt-1 items-start max-[650px]:items-center'>
                            ...
                            <button className='relative flex flex-row items-center justify-center mt-[5%] bg-gray-800 text-gray-200 p-2 rounded-lg text-[1.2vmax] font-semibold font-poppins max-[650px]:text-[2vmax] '><a href="mailto:chinmay29.lale@gmail.com">Download CV<i class="ml-1 ri-file-download-line "></i> </a></button>
                        </div>
                    </div>
                </div>
            </div>
